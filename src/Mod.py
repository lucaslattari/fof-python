...
def getAvailableMods(engine):
    ...
    try:
        ...
        # Mantém compatibilidade: apenas avisa e retorna lista vazia
        import Log

        # Se quiser, dá pra logar o erro também sem mudar comportamento:
        # Log.warn(f"Could not find mods directory: {modPath} ({e})")
